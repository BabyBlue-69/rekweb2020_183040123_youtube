...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UC1dI4tO13ApuSX0QeX8pHng&key=AIzaSyBR-Xe_E2pDLJMcr9cOVHiIbt4XSOReod4');

$profileYoutubePic = $result['items'][0]['snippet']['thumbnails']['medium']['url'];
$channelName = $result['items'][0]['snippet']['title'];
$subscriber = $result['items'][0]['statistics']['subscriberCount'];
//video terbaru
$video = get_CURL('https://www.googleapis.com/youtube/v3/channels?key=AIzaSyBR-Xe_E2pDLJMcr9cOVHiIbt4XSOReod4&Channelid=UC1dI4tO13ApuSX0QeX8pHng&maxResult=1&order=date&part=snippet');
...
<body>
        ...
        <div>
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="g-ytsubscribe" data-channelid="UC1dI4tO13ApuSX0QeX8pHng" data-layout="default" data-count="default"></div>
            </div>
          </div>
          <div class="row">
            <div class="col mt-2">
  ...
  <footer>
    <div class="container text-center">
      <div class="row">
        <div class="col-sm-12">
          <p>&copy; copyright<i class="glyphicon glyphicon-heart"></i> by. <a href="https://www.instagram.com/gadgetins/?hl=en">GadgetIn</a>.</p>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-12">
          <a href="https://www.youtube.com/channel/UC1dI4tO13ApuSX0QeX8pHng" class="btn btn-danger"><i class="glyphicon glyphicon-play"></i> Subscribe to YouTube</a>
        </div>
      </div>
    </div>
  </footer>
